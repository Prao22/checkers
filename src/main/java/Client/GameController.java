...
public class GameController extends MessageController implements IController {
    ...
    public void serviceMessage(Message message) {
        ...
        switch (gameMessage.getGameMessageType()) {
            case INFORMATION: {
                informationHandler((GameInformation) gameMessage);
                break;
            }

            case ANSWER: {
                answerHandler((Answer) gameMessage);
                break;
            }

            case MOVE: {
                moveHandler((Communication.Move) gameMessage);
                break;
            }

            case PARAMETERS: {
                parametersHandler((Parameters) gameMessage);
                break;
            }
            ...
            case START: {
                startHandler((Start) gameMessage);
                break;
            }
            ...
            case WINNER: {
                winnerHandler((Winner) gameMessage);
                break;
            }
